...
if (isset($id_Permintaan)) {
	...
	if ($konfirmasi == true) {
		header('location:'.$base_url.'kepala-unit/perlengkapan/permintaan/?message_success');
	}else{
		header('location:'.$base_url.'kepala-unit/perlengkapan/permintaan/?message_failed');
	}
}
