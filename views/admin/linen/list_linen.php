                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-nowrap"><a href="javascript:void(0)" onclick='getKelas("<?=$data_linen['id_ruang']?>")' id="<?=$data_linen['id_linen']?>" data-toggle="modal" data-target="#modalEdit" class="btn btn-info waves-effect m-r-20 edit_linen"> EDIT</a>
                                                            <a href="javascript:void(0)" id="<?=$data_linen['id_linen']?>" class="btn btn-danger waves-effect delete_linen">HAPUS</a></td>
                                                    </tr>
                                                <?php
                                                    }
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="defaultModalLabel">TAMBAH DATA LINEN</h4>
                                </div>
                                <div class="modal-body">
                                    <!-- Basic Validation -->
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form id="form_validation" action="<?php echo $base_url ?>controller/admin/linen/tambah_linen/" method="POST">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" name="linen" placeholder="Nama Linen" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" id="kelas_linen" style="display: none;">
                                                    <div class="form-line">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="number" min="5" class="form-control" name="jumlah_linen" placeholder="Jumlah Linen" required>
                                                    </div>
                                                </div>
                                        </div>
                                    </div>
