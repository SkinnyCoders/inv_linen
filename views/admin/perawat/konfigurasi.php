                ...
                <div class="container-fluid">
                    <div class="block-header">
                        ...
                        <ol class="breadcrumb align-right">
                            ...
                            <li><a href="javascript:void(0);">Konfigurasi Perawat</a></li>
                            <li class="active">Tambah Konfigurasi Perawat</li>
                        </ol>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                            <div class="card">
                                <div class="header">
                                    <a href="javascript:void(0)" class="btn btn-primary waves-effect pull-right" data-toggle="modal" data-target="#modalRuang">Tambah Konfigurasi Perawat</a>
                                    <h2>
                                        DAFTAR RUANG KELAS
                                    </h2>
                                </div>
                                        ...
                                        <table id="table_user" class="table table-striped table-hover" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 50%;" class="text-nowrap">Nama Perawat</th>
                    ...
                    <div class="modal fade" id="modalRuang" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title" id="defaultModalLabel">Konfigurasi Perawat</h4>
                                </div>
                                <div class="modal-body">
                                    <!-- Basic Validation -->
                                    <div class="row clearfix">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <select class="form-control show-tick m-t-20" name="ruang" id="as_user">
                                                            <?php 
                                                            $sqlKelas = mysqli_query($conn, "SELECT `id_user`,`nama_user` FROM `user` WHERE id_level = 4");
                                                            while ($dataKelas = mysqli_fetch_assoc($sqlKelas)) {
                                                             ?>
                                                            <option value="<?=$dataKelas['id_user']?>"><?=$dataKelas['nama_user']?></option>
                                                            <?php } ?>
                                                        </select>
                                                        <label for="as_user" class="form-label">Pilih Perawat</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="form-line">
