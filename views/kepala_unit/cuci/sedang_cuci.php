                ...
                <div class="container-fluid">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                <div class="header">
                                    <a href="javascript:void(0)" class="btn btn-primary waves-effect pull-right" data-toggle="modal" data-target="#modalAdd">Cari Linen Dicuci</a>
                                    <h2>
                                        <?php 
                                        ...
                                        DAFTAR LINEN DICUCI - <?=$tanggalKet?>
                                    </h2>
                                </div>
                                <div class="body">
                                        ...
                                        <table id="table_user_list" class="table table-striped table-hover" style="width: 100%">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_GET['ruang']) && !empty($_GET['ruang'])) {
                                                    $ruang = $_GET['ruang'];
                                                    $where = "DATE(`tgl_cuci`) = '$tanggal' AND pencucian.`status` = 'cuci' AND ruang.nama_ruang = '$ruang' ORDER BY linen.nama_linen ASC";
                                                }else{
                                                    $where = "DATE(`tgl_cuci`) = '$tanggal' AND pencucian.`status` = 'cuci' ORDER BY linen.nama_linen ASC";
                                                }

                                                    $getLinenKotor = mysqli_query($conn, "SELECT pencucian.id_pencucian AS id, pencucian.id_proses_cuci, linen.nama_linen, kategori.nama_kategori, ruang.nama_ruang, kelas.nama_kelas, jenis.jumlah, jenis.jenis FROM `pencucian` INNER JOIN linen_kotor AS kotor ON kotor.id_linen_kotor=pencucian.id_linen_kotor INNER JOIN jenis_linen_kotor AS jenis ON jenis.id_jenis_linen_kotor=pencucian.id_jenis_linen_kotor INNER JOIN linen ON linen.id_linen=kotor.id_linen INNER JOIN kategori ON kategori.id_kategori=linen.id_kategori INNER JOIN ruang ON ruang.id_ruang=linen.id_ruang INNER JOIN kelas ON kelas.id_kelas=linen.id_kelas WHERE ".$where);
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="defaultModalLabel">CARI LINEN DICUCI</h4>
                                </div>
            ...
            <script>
                ...
                $(document).ready(function() {
                    $('#table_user_list').DataTable({
                        ...
                        buttons: [{
                              extend: 'pdfHtml5',
                              title: 'Data Linen Dicuci tanggal <?=$tanggalKet?>' 
                            },{
                                extend: 'excel',
                                title: 'Data Linen Dicuci tanggal <?=$tanggalKet?>'
                            },
