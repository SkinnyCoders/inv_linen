                                        ...
                                        <table id="table_user_list" class="table table-striped table-hover dataTable js-exportable" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 30%;" class="text-nowrap">Nama Ruang</th>
                                                    <th style="width: 20%;" class="text-nowrap">Tanggal</th>
                                                    <th style="width: 30%;" class="text-nowrap">Ketepatan</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                ...
                                                // }
                                                    $getLinen = mysqli_query($conn, "SELECT ruang.nama_ruang, DATE(`tanggal`) AS tanggal, `status` FROM `ketepatan` INNER JOIN ruang ON ruang.id_ruang=ketepatan.id_ruang WHERE 1");
                                                    while ($data_linen = mysqli_fetch_assoc($getLinen)) {
                                                        $waktu = DateTime::createFromFormat('Y-m-d', $data_linen['tanggal'])->format('d F Y');
                                                ?>
                                                    <tr>
                                                        <td><?= $no++ ?></td>
                                                        <td><?= ucwords($data_linen['nama_ruang']) ?></td>
                                                        <td><?= ucwords($waktu) ?></td>
                                                        <td><?= ucwords($data_linen['status']) ?></td>
                                                    </tr>
                                                <?php
                                                    }
